...
HTML_TITLE="Curso VirtualBox y Vagrant"
HTML_CSS_URL="https://stackedit.io/res-min/themes/base.css"
...
$(HTML_OUTPUT):	$(MARKDOWN_INPUT)
	${PANDOC} --from ${PANDOC_INPUT} --to ${PANDOC_OUTPUT} \
	  --section-divs --title-prefix $(HTML_TITLE) --css $(HTML_CSS_URL) --css $(HTML_CSS_FILE) --include-in-header $(HTML_HEADER) --include-before-body $(HTML_BEFORE) --include-after-body $(HTML_FOOTER) \
